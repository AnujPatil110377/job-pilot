      ...
      <div className="container relative flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:flex-col lg:w-1/2 p-12 justify-between relative">
          ...
          <div className="space-y-6">
            <h3 className="text-gray-600 dark:text-gray-400 font-medium">Why choose JobPilot?</h3>
            <div className="grid grid-cols-2 gap-4">
              {[
                { title: "Easy Application", desc: "One-click job applications" },
                { title: "Profile Analytics", desc: "Track your application success" },
                { title: "Skill Assessment", desc: "Evaluate your expertise" },
                { title: "Job Alerts", desc: "Real-time opportunity notifications" },
              ].map((feature) => (
