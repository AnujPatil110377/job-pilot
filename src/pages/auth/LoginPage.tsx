...
const FEATURES = [
  { 
    ...
    bg: "bg-gradient-to-br from-[#C8E6C9] to-[#B2EBF2]"
  },
  { 
    title: "Career Growth", 
    desc: "Professional development tools",
    bg: "bg-[#E8F5E9]"
  },
  { 
  ...
  { 
    ...
    desc: "Practice with AI interviews",
    bg: "bg-[#EDE7F6]"
  },
  { 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="container relative flex min-h-screen">
        {/* Left Section with Quote and Features (remove the logo from here) */}
        <div className="hidden lg:flex lg:flex-col lg:w-1/2 p-12 justify-start relative">
          {/* Quote */}
          <div className="relative mt-24"> {/* Added margin-top to account for fixed logo */}
          ...
          <div className="space-y-6 mt-20">
            <h3 className="text-center text-2xl text-gray-600 dark:text-gray-400 font-medium">
